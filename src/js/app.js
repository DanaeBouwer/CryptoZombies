App = {
     ...
     createRandomZombie: function () {
      ...
      randomHex: function (dna) {
          var hexCode = dna.toString(16).substring(0,6);
          return hexCode;
      },

      invertHex: function(randomHex) {
          var compl = 0xFFFFFF ^ randomHex;
          return compl.toString(16).substring(0,6);
      },
      ...
      displayZombie: function (id, name, dna, level, readyTime, winCount, lossCount) {
          ...
          //element.setAttribute("style", "background-color: randomHex; color: invertHex");
          ...
          var back_color = '#'+ App.randomHex(dna)
          var color = '#' + App.invertHex(back_color)

          zombieTemplate.find('.panel-heading').attr('style', 'background-color:'+ back_color +';color:'+ color);
